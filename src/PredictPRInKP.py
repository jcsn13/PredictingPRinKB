...
class PredictPRinKP:
    ...
    def perform_train_gwas(self):
        ...
        for i in self.datasets_gwas:
            ...
            self.perform_feature_selection(dataset, metadata, True)
    ...
    def train_SGDClassifier(self, dataset, metadata, name):
        ...
        grid = GridSearchCV(model, parameters, cv=10, return_train_score=True)
    ...
    def train_GBTC(self, dataset, metadata, name):
        ...
        parameters = {'learning_rate': [0.001, 0.01, 0.1], 'n_estimators': [50, 100, 200, 300, 400, 500],
                      'max_depth': [3, 5, 10, 12, 15], 'min_samples_leaf': [20, 50, 100, 150],
    ...
    def perform_XGB(self, dataset, metadata, name):
        ...
        model = xgb.XGBClassifier(random_state=self.SEED, learning_rate=0.2, n_estimators=600,
